        ...
        <div className='flex flex-col'>
            <div className='eventStep2Form p-6 space-y-8'>
                ...
                <div className='space-y-5'>
                    <p className='text-black font-bold font-sans text-2xl'>{event?.name}</p>
                ...
                <div>
                    <div className='flex w-full justify-between items-center'>
                        <p className='text-xl font-medium'>Ticket Delivery Information</p>
                    ...
                    >
                        <div className='border border-gray-300 mt-4 p-4 rounded-lg shadow-sm'>
                            <p className='font-semibold text-lg text-gray-800'>Customer Information</p>
                            <ul className="space-y-2 text-gray-700 mt-2 text-base">
                        ...
                        <div className='border border-gray-300 mt-4 p-4 rounded-lg shadow-sm text-lg'>
                ...
                <div>
                    <div className='flex w-full justify-between items-center'>
                        <p className='text-xl font-medium'>Ticket Type Information</p>
                    ...
                    <div
                        className={`transition-all duration-300 ease-in-out overflow-hidden ${isShownType ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'
                            }`}
                    >
                        {selectedTickets.map((ticket, index) => (
                            <div key={index} className='text-lg grid grid-cols-6 border border-gray-300 mt-4 px-4 py-2 rounded-lg shadow-sm'>
                                <div className='flex flex-col justify-center items-start col-span-4'>
            ...
            <div className='eventStep2Form'>
                <div className='flex justify-between items-center w-ful p-6 pb-4'>
                    <p className='font-semibold text-xl'>Payment Information</p>
